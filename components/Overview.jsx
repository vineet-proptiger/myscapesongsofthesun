      ...
      <div className="flex flex-col lg:flex-row items-start gap-10 lg:gap-14">
        ...
        <div className="w-full lg:w-1/2" data-aos="fade-right">
          ...
          <p style={{
            ...
            Myscape Songs of the Sun comprises of 4 towers of linear residences built in only two formats – the 2900 sq ft, 3 BHK apartments and the 3300 sq ft, 4 BHK apartments. With 4 units to a floor, each apartment resides in one corner of the tower, allowing for indoor outdoor integration and improved daylight penetration. The site houses 592 residences among four towers that are Ground + 37 floors high.
          </p>
          <p style={{
            fontFamily: F_SANS, fontSize: '14.5px', color: '#4A4540',
            lineHeight: 1.9,
            ...
            Set against the vibrant backdrop of Hyderabad's Financial District, Songs of the Sun redefines contemporary luxury by seamlessly blending architectural brilliance with serene natural surroundings. Every residence is meticulously crafted to offer unparalleled privacy, expansive living spaces, and world-class amenities designed for the discerning few.
          </p>
