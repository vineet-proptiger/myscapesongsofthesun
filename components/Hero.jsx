    ...
    <section className="hero-container">
      ...
      <div className="hero-slider-wrapper grid md:hidden">
        <div className="slide-layer active" style={{ gridArea: '1 / 1 / 2 / 2' }}>
          <Image
            ...
            alt="Songs of the Sun Mobile Banner"
            width={768}
            height={800}
            className="hero-image"
            priority={true}
      ...
      <div className="hero-content">
        ...
        <p className="hero-subtitle">
          <span style={{ fontSize: '0.85em', fontWeight: 500, textTransform: 'none' }}>At Financial District,Hyderabad</span>
        </p>
        {/* Bullet Points */}
        <div className="hero-bullets" style={{ marginBottom: '24px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          {[
            'Songs of the Sun – Luxury Rooted in Trust',
            '100% Vastu Homes, One Prestigious Address',
            'G+37 Luxury Towers | MyScape Assurance',
            '6 Acres. Infinite Possibilities at Financial District',
            'Luxury Towers. Timeless MyScape Living'
          ].map((text, i) => (
